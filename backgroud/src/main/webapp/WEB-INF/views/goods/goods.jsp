...
<link href="/js/jquery-easyui/themes/default/easyui.css"
	rel="stylesheet">
...
<body>
					...
					<div class="row">
						...
						<div class="col-md-3">
							<input class="form-control" id="searchInfo"
								placeholder="searchInfo" name="" type="text" />
						</div>
						<div class="col-md-6">
							<div class="row">
								<div class="col-md-12">
										...
										<div class="row">
											<div class="col-md-5">
												<input type="text" class="form-control" id="lowPrice"
													name="lowPrice" placeholder="lowPrice">
											</div>
											<div class="col-md-1">
												<span style="font-size: x-large;">━</span>
											</div>
											<div class="col-md-5">
												<input type="text" class="form-control" id="tallPrice"
													name="tallPrice" placeholder="tallPrice">
											</div>
										</div>
									</div>
								</div>
						...
						<button type="button" class="btn btn btn-primary btn-sm"
							id="searchs">搜索</button>
					</div>
				</div>
				<div class="col-md-2">
					<button type="button" class="btn btn btn-info btn-sm goodsInfo"
						genre="addInfo">添加</button>
					<button type="button" class="btn btn btn-warning btn-sm"
						id="deleteGoodsInfoAll">删除</button>
				</div>
			</div>
			<div class="row">
				<div class="col-md-1"></div>
				<div class="col-md-10">
						...
						<tbody>
							<c:if test="${not empty goodsInfos}">
								<c:forEach items="${goodsInfos}" var="goods">
									<tr>
										<td><input class="deleteOne" type="checkbox"
										...
										<td>
											<button type="button"
												class="btn btn btn-info btn-primary btn-xs goodsInfo"
												genre="updateGoodsInfo" value="${goods.goodsId}">修改</button>
											<button type="button"
												class="btn btn btn-warning btn-primary btn-xs goodsInfoDelete"
												value="${goods.goodsId}">删除</button>
										</td>
									</tr>
								</c:forEach>
							</c:if>
					...
					<input type="hidden" id="count" value="${count}"> <input
						type="hidden" id="pages" value="${pages}">
				</div>
			</div>
		</div>
	...
	<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog"
		aria-labelledby="gridSystemModalLabel" id="info">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="goodsInfoForm">
						...
						<div class="row">
								...
								<div class="row">
									<div class="col-xs-5">
										<div class="input-group-btn">
											<button type="button"
												...
												data-toggle="dropdown" aria-haspopup="true"
												aria-expanded="false" id="sortInfoChange">
												选择 <span class="caret"></span>
											</button>
									...
									<div class="col-xs-7">
										<input type="text" class="form-control" id="sortName"
											name="sortName" value="${sortName }" readonly="readonly">
							...
							<div class="col-xs-5">
								<label for="goodsName">GOODS_NAME</label> <input type="text"
									class="form-control" id="goodsName" placeholder="GOODS_NAME"
									name="goodsName">
							</div>
						</div>
						<div class="row">
							<div class="col-xs-5 col-md-offset-1">
								<label for="goodsPrice">GOODS_PRICE</label> <input type="text"
									class="form-control" id="goodsPrice" placeholder="GOODS_PRICE"
									name="goodsPrice">
							</div>
							<div class="col-xs-5">
								<label for="goodsCount">GOODS_COUNT</label> <input type="text"
									class="form-control" id="goodsCount" placeholder="GOODS_COUNT"
									name="goodsCount">
							</div>
						</div>
						<div class="row">
							<div class="col-xs-10 col-md-offset-1">
								...
								<textarea class="form-control" rows="2" id="goodsDesc"
									name="goodsDesc"></textarea>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-10 col-md-offset-1">
								<label for="goodsImage">GOODS_IMAGE</label> <img src="..."
									class="img-responsive" alt="Responsive image" id="goodsImage"
									name="goodsImage">
							</div>
						</div>
				...
				<div class="modal-footer">
					...
					<button type="button" id="save" data-loading-text="Loading..."
						class="btn btn-primary" autocomplete="off">Save</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
